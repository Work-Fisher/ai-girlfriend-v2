...
from speech_to_speech.LLM.sentence_tokenizer import sent_tokenize
...
class BaseOpenAICompatibleHandler(BaseHandler[LLMIn, LLMOut], ABC):
    ...
    def setup(
        ...
        max_output_characters: Optional[int] = None,
        ...
        **_kwargs: Any,
        ...
        self.max_output_characters = max(0, int(max_output_characters or 0))
