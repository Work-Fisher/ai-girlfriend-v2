...
class ModuleArguments:
    ...
    tts: Optional[Literal["chatTTS", "facebookMMS", "pocket", "kokoro", "qwen3", "omnivoice"]] = field(
        default="qwen3",
        metadata={
            "help": (
                "The TTS to use. Either 'chatTTS', 'facebookMMS', 'pocket', 'kokoro', 'qwen3', "
                "or 'omnivoice' (voice cloning via the sidecar service in app/omnivoice). "
                "Default is 'qwen3'."
            )
        },
    )
