...
本项目的浏览器前端 UI 部分参考并修改了 `penposs` 作者公开分享的“开源赛博女友”项目。感谢作者公开分享前端设计与实现：

- [原作者的飞书资料页](https://e5fklqa5fj.feishu.cn/wiki/ZPFIwAWzfiDilAkcHk0czuiRnhf)
- [penposs 的 GitHub](https://github.com/penposs)

前端参考部分来自原作者公开发布的开源版本；来源页没有附带可供本仓库复述的统一许可证名称，因此这里保留原作者署名与来源，不擅自把它标成 MIT、Apache-2.0 等具体许可证。DSH 长期记忆、语义历史检索、记忆管理、关系进度、两种输出模式和新版首次安装流程由当前项目实现。第三方代码、模型和二进制仍分别遵循各自上游条款。
